...
Run inside Docker:
  docker compose exec netbox python manage.py test netbox_pdu_control.tests.test_models -v2
"""
...
class ManagedPDUModelTest(TestCase):
    ...
    def test_config_backup_defaults(self):
        ...
        self.assertEqual(pdu.config_backup_status, SyncStatusChoices.NEVER)

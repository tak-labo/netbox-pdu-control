...
Run inside Docker:
  docker compose exec netbox python manage.py test netbox_pdu_control.tests.test_api -v2
"""
...
class ManagedPDUAPITest(PluginAPITestCase):
    ...
    def setUp(self):
        super().setUp()
        self.list_url_name = "plugins-api:netbox_pdu_control-api:managedpdu-list"
        self.detail_url_name = "plugins-api:netbox_pdu_control-api:managedpdu-detail"
    ...
    def test_delete_managed_pdu(self):
        self.add_permissions("netbox_pdu_control.delete_managedpdu")
...
class PDUOutletAPITest(PluginAPITestCase):
    ...
    def setUp(self):
        super().setUp()
        self.list_url_name = "plugins-api:netbox_pdu_control-api:pduoutlet-list"
        self.detail_url_name = "plugins-api:netbox_pdu_control-api:pduoutlet-detail"
...
class PDUInletAPITest(PluginAPITestCase):
    ...
    def setUp(self):
        super().setUp()
        self.list_url_name = "plugins-api:netbox_pdu_control-api:pduinlet-list"
        self.detail_url_name = "plugins-api:netbox_pdu_control-api:pduinlet-detail"

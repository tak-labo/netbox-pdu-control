...
urlpatterns = (
    ...
    path(
        "outlets/",
        include(get_model_urls("netbox_pdu_control", "pduoutlet", detail=False)),
    ),
    path(
        "outlets/<int:pk>/",
        include(get_model_urls("netbox_pdu_control", "pduoutlet")),
    ),
    path(
        "outlets/<int:pk>/sync/",
    ...
    path(
        "inlets/",
        include(get_model_urls("netbox_pdu_control", "pduinlet", detail=False)),
    ),
    path(
        "inlets/<int:pk>/",
        include(get_model_urls("netbox_pdu_control", "pduinlet")),
    ),
    path(
        "inlets/<int:pk>/sync/",

...
class ManagedPDU(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_pdu_control:managedpdu", args=[self.pk])
...
class PDUOutlet(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_pdu_control:pduoutlet", args=[self.pk])
...
class PDUInlet(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_pdu_control:pduinlet", args=[self.pk])

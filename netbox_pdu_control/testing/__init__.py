"""
Standalone testing base classes for NetBox PDU Plugin.
    ...
    def add_permissions(self, *permissions: str):
        ...
        Args:
            *permissions: Permission names in format "app.action_model"
                         e.g., "netbox_pdu_control.add_pdu"

        Example:
            self.add_permissions(
                "netbox_pdu_control.view_pdu",
                "netbox_pdu_control.add_pdu",
            )
        """
...
class PluginViewTestCase(PluginModelTestCase):
    ...
    def _get_base_url(self) -> str:
        ...
        Returns:
            Base URL string (e.g., "plugins:netbox_pdu_control:pdu")
        """
